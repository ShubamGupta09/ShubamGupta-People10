...
//            guard let bodyData = JSONStringify(withJSON: params) else {
//                threadSwitcher = ThreadSwitcher(status: .serialisationError, response: nil, message: "Invalid JSON format", urlString: request.url?.absoluteString)
//                return
//            }
